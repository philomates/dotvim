...
if !exists('g:showmarks_enable'      ) | let g:showmarks_enable       = 0    | endif
...
hi default ShowMarksHLl ctermfg=darkblue ctermbg=black cterm=bold guifg=blue guibg=black gui=bold
hi default ShowMarksHLu ctermfg=darkblue ctermbg=black cterm=bold guifg=blue guibg=black gui=bold
hi default ShowMarksHLo ctermfg=darkblue ctermbg=black cterm=bold guifg=blue guibg=black gui=bold
hi default ShowMarksHLm ctermfg=darkblue ctermbg=black cterm=bold guifg=blue guibg=black gui=bold
